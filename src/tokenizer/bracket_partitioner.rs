...
pub(crate) type PartitionStream = Vec<Partitioner>;
...
pub(crate) fn deserialize_to_string(partition_stream: PartitionStream) -> String {
    "".to_string()
}
